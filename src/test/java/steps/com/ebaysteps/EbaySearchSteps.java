...
import pages.com.ebaypage.EbayHomePage;
import pages.com.ebaypage.EbaySearchResultsPage;
...
public class EbaySearchSteps {
    ...
    @Then("user see results about iMac only")
    public void user_see_results_about_i_mac_only() {
